...
/*************************
//insmod /mnt/nfs/modules_8136/fbtft_device.ko busnum=1 name=admatec_c-berry28 cs=0 gpios=reset:1,led:2,dc:0 custom=1 speed=6000000 width=240 height=240
tftp 2000000 uImage_8136;bootm 2000000
/mnt/mtd/nfs.sh
insmod /mnt/nfs/modules_8136/fbtft_device.ko rotate=0 busnum=1 name=admatec_c-berry28 cs=0 gpios=reset:1,led:2 custom=1 speed=6000000 width=320 height=240 buswidth=9 mode=0
insmod /mnt/nfs/modules_8136/fb_st7789v.ko
...
tftp 2000000 uImage_8136;bootm 2000000
/mnt/mtd/nfs.sh
insmod /mnt/nfs/modules_8136/fbtft_device.ko rotate=0 width=240 height=320 busnum=1 name=admatec_c-berry28 cs=0 gpios=reset:1,led:2 custom=1 speed=6000000 buswidth=9 mode=0;insmod /mnt/nfs/modules_8136/fb_st7789v.ko
rmmod /mnt/nfs/modules_8136/fb_st7789v.ko;rmmod /mnt/nfs/modules_8139/fbtft_device.ko
...
static struct spi_device *spi_fft;
...
static int tft_fd = -1;
static pmuReg_t pmu_tft_reg[] = {
    /* off,		bitmask,		lockbit,		init val,		init mask */
    {0x50, 	0xff,		0xff,		0x55,		0xff},        /* pinMux with NAND */
};

static pmuRegInfo_t pmu_tft_reg_info = {
    "SPI010_TFT",
    ARRAY_SIZE(pmu_tft_reg),
    ATTR_TYPE_NONE,
    pmu_tft_reg
};
#endif
...
static int cberry28_init_sequence[] = {
	...
	-1, MIPI_DCS_SET_PIXEL_FORMAT, MIPI_DCS_PIXEL_FMT_16BIT | 0x50,
	-1, MIPI_DCS_SET_ADDRESS_MODE, 0x08,
	
	-1, 0xe0, 0xd0, 0x00, 0x09, 0x0c, 0x0e, 0x28, 0x31, 0x43, 0x42, 0x3a, 0x14, 0x15, 0x15, 0x1a,
	-1, 0xe1, 0xd0, 0x00, 0x09, 0x0c, 0x0c, 0x28, 0x2d, 0x45, 0x41, 0x3b, 0x19, 0x16, 0x15, 0x1b,
...
//                                        { "dc", 22 },	xusong
 ...
 static int fbtft_device_spi_device_register(struct spi_board_info *spi)
 {
         ...
         spi_fft = spi_new_device(master, spi);
...
#ifdef CONFIG_PLATFORM_GM8136
	tft_fd = ftpmu010_register_reg(&pmu_tft_reg_info);
	if (tft_fd < 0){
		pr_err("failed to register SPI device\n");
		return ret;
	}
	if(gpio_request(0, "gpio_0") < 0) {
 ...
 static void __exit fbtft_device_exit(void)
 {
	...
	if (tft_fd != -1){
		gpio_free(0);
		gpio_free(3);
		ftpmu010_deregister_reg(tft_fd);
	}
 #endif
 }
